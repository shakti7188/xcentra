...
export const metadata: Metadata = {
  ...
  description:
    "Launch your own branded virtual and physical debit cards powered by the Xhavic blockchain. Custom branding, full program management, and global acceptance at 150M+ merchants.",
  openGraph: {
    title: "White Label Cards — Launch Your Branded Debit Card | Xcentra",
    description:
